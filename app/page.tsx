...
const services = [
  {
    icon: Globe,
    title: "비자/출입국",
    description: "D-8, E-7, F-4, F-5 비자 발급 신청 등 외국인 비자 업무를 전담합니다.",
  },
  {
    icon: Building2,
    title: "법인 설립",
    description: "농업법인 설립, 사회적협동조합 설립, 각종 단체 등록 업무를 전문적으로 대행합니다.",
  },
  {
    icon: Shield,
    title: "국가유공자",
    description: "국가 유공자 등록 등 보훈 업무, 등급 조정 등을 체계적으로 지원합니다.",
  },
  {
    icon: Gavel,
    title: "민원 행정",
    description: "행정심판 및 이의신청(권리구제), 인허가 신청 등 민원 행정업무를 처리합니다.",
  },
]
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
                ...
                >
                  <span className="text-lg font-semibold">010-8562-7792</span>
                </a>
              </div>
            </div>
          </div>
